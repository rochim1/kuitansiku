...
<section id="about" class="position-relative">
    <div  class="carousel slide top bg-linear-yellowsoft position-absolute" data-ride="carousel">
    </div>
    <div class="container h-100 w-100 top-0">
        ...
        <div class="row pt-3 d-flex justify-content-center">
            <div class="col-md-3 col-sm-6">
                <div class="our-team">
                    ...
                    <div class="team-content bg-linear-yellowsoft">
